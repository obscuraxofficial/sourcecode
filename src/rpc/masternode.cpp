...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print obscuraX address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "obscurax",               "masternode",             &masternode,             true,  {} },
    { "obscurax",               "masternodelist",         &masternodelist,         true,  {} },
    { "obscurax",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "obscurax",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "obscurax",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "obscurax",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
