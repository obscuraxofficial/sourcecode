...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in obscurax.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("obscurax.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* obscuraX features */
    { "obscurax",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "obscurax",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "obscurax",               "gobject",                &gobject,                true,  {} },
    { "obscurax",               "voteraw",                &voteraw,                true,  {} },
