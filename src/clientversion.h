...
//! These need to be macros, as clientversion.cpp's and obscurax*-res.rc's voodoo requires it
...
/**
 * obscuraxd-res.rc includes this file, but it cannot cope with real c++ code.
