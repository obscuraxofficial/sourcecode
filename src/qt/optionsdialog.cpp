    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("OBSX-light"), QVariant("light"));
    ui->theme->addItem(QString("OBSX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("OBSX-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("OBSX-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("OBSX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("OBSX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("OBSX-traditional"), QVariant("trad"));
