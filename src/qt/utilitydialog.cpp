    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  obscurax-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the obscuraX in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 OBSX, 0.1 OBSX, 1 OBSX and 10 OBSX -- sort of like the paper money you use every day.</li> \
