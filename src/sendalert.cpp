...
2. run obscuraxd with -printalert or -sendalert like this:
   /path/to/obscuraxd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.obscurax.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/obscuraX Core:0.12.0.58/"));
