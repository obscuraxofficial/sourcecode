...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid obscurax address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid obscurax address" in e.error['message'])
