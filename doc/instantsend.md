...
This mechanism has been integrated into Bitcore-Node-obscuraX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/obscuraxpay/insight-api-obscurax#web-socket-api](https://github.com/obscuraxpay/insight-api-obscurax#web-socket-api)
* API: [https://github.com/obscuraxpay/insight-api-obscurax#instantsend-transactions](https://github.com/obscuraxpay/insight-api-obscurax#instantsend-transactions)
...
By default, the obscuraX Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the obscuraX Core daemon:
