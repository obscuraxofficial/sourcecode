...
This document provides guidelines for internationalization of the obscuraX Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `obscurax_en.ts` remains unchanged.
